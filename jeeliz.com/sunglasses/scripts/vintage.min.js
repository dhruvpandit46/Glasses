    ...
    return function e(t, n, r) {
        ...
        2: [function(require, module, exports) {
            ...
            var getLUT = function getLUT(effect) {
                ...
                if (curves) {
                    rMod = (0,
                    _utils.compose)(curvesFn(curves.r), rMod);
                    gMod = (0,
                    _utils.compose)(curvesFn(curves.g), gMod);
                    bMod = (0,
                    _utils.compose)(curvesFn(curves.b), bMod)
                }
                if (contrast) {
                    var f = contrastFn(contrast);
                    rMod = (0,
                    _utils.compose)(f, rMod);
                    gMod = (0,
                    _utils.compose)(f, gMod);
                    bMod = (0,
                    _utils.compose)(f, bMod)
                }
                if (brightness) {
                    var _f = brightnessFn(brightness);
                    rMod = (0,
                    _utils.compose)(_f, rMod);
                    gMod = (0,
                    _utils.compose)(_f, gMod);
                    bMod = (0,
                    _utils.compose)(_f, bMod)
                }
                if (screen) {
                    var _f2 = screenFn(screen.a);
                    rMod = (0,
                    _utils.compose)(_f2(screen.r), rMod);
                    gMod = (0,
                    _utils.compose)(_f2(screen.g), gMod);
                    bMod = (0,
                    _utils.compose)(_f2(screen.b), bMod)
                }
                ...
                return function(_ref) {
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        for (var i = id.length / 4; i >= 0; --i) {
                            ...
                            var b = LUT[2][id[bi]];
                            if (sepia) {
                                var _ref3 = [r * .393 + g * .769 + b * .189, r * .349 + g * .686 + b * .168, r * .272 + g * .534 + b * .131];
                                r = _ref3[0];
                                g = _ref3[1];
                                b = _ref3[2]
                            }
                        ...
                        if (effect.vignette) {
                            ...
                            ctx.fillStyle = (0,
                            _utils.getGradient)(ctx, width, height, ["rgba(0,0,0,0)", "rgba(0,0,0,0)", "rgba(0,0,0," + effect.vignette + ")"]);
                            ctx.fillRect(0, 0, width, height)
                        }
                        if (effect.lighten) {
                            ctx.globalCompositeOperation = supportsBlendModes ? "screen" : "lighter";
                            ctx.fillStyle = (0,
                            _utils.getGradient)(ctx, width, height, ["rgba(255,255,255," + effect.lighten + ")", "rgba(255,255,255,0)", "rgba(0,0,0,0)"]);
                            ctx.fillRect(0, 0, width, height)
                        }
                        if (!effect.viewfinder) {
                            return resolve((0,
                            _utils.getResult)(canvas))
                        }
                        return (0,
                        _utils.loadImageWithCache)(effect.viewfinder).then(function(img) {
                            if (supportsBlendModes) {
                                ctx.globalCompositeOperation = "multiply";
                                ctx.drawImage(img, 0, 0, width, height)
                            } else {
                                var _createCanvasAndCtxFr = (0,
                                _utils.createCanvasAndCtxFromImage)(img, width, height)
            ...
            exports.default = function(src, partialEffect) {
                var genSource = typeof src === "string" ? (0,
                _utils.loadImage)(src).then(_utils.getCanvasAndCtx) : Promise.resolve((0,
                _utils.getCanvasAndCtx)(src));
        ...
        3: [function(require, module, exports) {
            ...
            var createCanvasAndCtxFromImage = exports.createCanvasAndCtxFromImage = function createCanvasAndCtxFromImage(el, width, height) {
                ...
                var ctx = (0,
                _nullthrows2.default)(canvas.getContext("2d"), "Could not get 2d context for canvas");
            ...
            var cloneCanvasAndCtx = exports.cloneCanvasAndCtx = function cloneCanvasAndCtx(source) {
                ...
                var targetCtx = (0,
                _nullthrows2.default)(target.getContext("2d"), "Could not get 2d context for canvas");
                target.width = width;
